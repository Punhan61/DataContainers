...
void main()
{
	...
	cout << "Среднее-арифметическое элементов в дерева: " << tree.Avg() << endl;
	...
	cout << "Сумма элементов дерев: " << unique_tree.Sum() << endl;
	cout << "Среднее-арифметическое элементов в дерева: " << unique_tree.Avg() << endl;
	...
	cout << "Сумма элементов дерева: " << my_tree.Sum() << endl;
	cout << "Среднее-арифметическое элементов в дерева: " << my_tree.Avg() << endl;
